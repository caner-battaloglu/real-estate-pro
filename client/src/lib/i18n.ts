...
const translations: Record<Language, TranslationDictionary> = {
  ...
  tr: {
    ...
    "landing.card.uk": "GBP üzerinden ilanları görüntüleyin ve ölçüleri metrekare olarak görün",
    ...
    "landing.uk.title": "Birleşik Krallık",
